    ...
    return (
        <div className="w-full h-24 bg-[#0D121E] md:px-32 p-2 flex items-center justify-between">
            ...
            <div className="flex md:space-x-10 space-x-2 items-center">
                <a href="https://www.instagram.com/wbarberclub/" className="pr-4">
                    <img src="./instagram.png" alt="Instagram" className="md:size-10 size-8" />
                </a>
                <button className="bg-[#D60F26] hover:bg-[#D60F26]/80 transition text-white md:px-4 md:py-2 md:text-base px-3 py-3 text-xs rounded-md">
